  ...
  return (
    ...
    >
      ...
      >
        ...
        <button type="button" onClick={() => setFilter("sleep")}>
          שינה
        </button>
        <button type="button" onClick={() => setFilter("sleep_food")}>
          שינה + אוכל
        </button>
        <button type="button" onClick={() => setFilter("food")}>
          אוכל
        </button>
        <button type="button" onClick={() => setFilter("food_poop")}>
          אוכל + קקי
        </button>
        <button type="button" onClick={() => setFilter("poop")}>
          קקי
        </button>
        <button type="button" onClick={() => setFilter("pee")}>
          פיפי
        </button>
        <button type="button" onClick={() => setFilter("medicine")}>
          תרופות
        </button>
      </div>
